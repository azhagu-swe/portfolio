export const PROJECTS_DATA = {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Built interactive geospatial visualizations using React.js and Mapbox for 50K+ data points. Optimized rendering performance for real-time updates.",
        technologies: ["React.js", "Mapbox", "PostgreSQL"],
        thumbnail: "https://via.placeholder.com/400x200",
        liveDemo: "https://github.com/azhagu-swe/geospatial-visualization",
        github: "https://github.com/azhagu-swe/geospatial-visualization",
      },
      {
