...
const AboutMe: React.FC = () => {
  ...
  return (
    <Box
      ...
      <Grid container spacing={{ xs: 3, sm: 4, md: 5 }} alignItems="center" sx={{ mb: { xs: 3, sm: 4, md: 5 } }}>
        <Grid
          item
          xs={12}
          md={4}
      ...
      <Box sx={{ mb: { xs: 3, sm: 4, md: 5 } }} component={motion.div} variants={itemVariants}>
        <Typography
          variant="h4"
          color="text.primary"
          sx={{ 
      ...
      <Box component={motion.div} variants={itemVariants} sx={{ mb: { xs: 3, sm: 4, md: 5 } }}>
        <Typography
          variant="h4"
          color="text.primary"
          sx={{ 
            ...
            <Card
              ...
              <CardContent sx={{ flexGrow: 1, p: { xs: 2, sm: 3, md: 4 } }}>
                ...
                <Typography
                  ...
                  Leveraging Alibaba Cloud&#39;s Qwen CLI for AI-powered code generation, optimization, and development assistance. Enhancing productivity through intelligent code suggestions and automated refactoring.
                </Typography>
                <Box component="ul" sx={{ pl: 2 }}>
                  <Typography component="li" variant="body2" sx={{ mb: 1, fontSize: { xs: "0.85rem", sm: "0.95rem" } }}>
                    Code generation and refactoring assistance
                  </Typography>
                  <Typography component="li" variant="body2" sx={{ mb: 1, fontSize: { xs: "0.85rem", sm: "0.95rem" } }}>
                    Automated documentation generation
                  </Typography>
                  <Typography component="li" variant="body2" sx={{ fontSize: { xs: "0.85rem", sm: "0.95rem" } }}>
            ...
            <Card
              ...
              <CardContent sx={{ flexGrow: 1, p: { xs: 2, sm: 3, md: 4 } }}>
                ...
                <Typography
                  ...
                  Utilizing Google&#39;s Gemini CLI for advanced AI-assisted development workflows. Integrating cutting-edge AI capabilities into the development process for enhanced problem-solving and innovation.
                </Typography>
                <Box component="ul" sx={{ pl: 2 }}>
                  <Typography component="li" variant="body2" sx={{ mb: 1, fontSize: { xs: "0.85rem", sm: "0.95rem" } }}>
